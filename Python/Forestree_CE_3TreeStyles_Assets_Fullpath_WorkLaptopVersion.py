...
if __name__ == "__main__":
    forestree_crosswalk_fullpath(
        r"C:\Temp\GIS\CityEngine\Forestree.xlsx",
        r"C:\Users\robejosh\OneDrive - Adelaide City Council\Documents\CityEngine\Default Workspace\CityEngine_Tour\assets\Trees\Tree_CE2025_MasterCrosswalk_Schematic_Key.csv",
        r"C:\Temp\GIS\CityEngine\Forestree_WithAssets_FullPath.csv",
        style="LowPoly"
    )
